...
import VolumeChart from './volume-chart.vue'
...
const metrics: Metric[] = [
  { label: 'Total Volume', value: '$110,100.00', icon: markRaw(PhChartBar), badge: '+8%', badgeTone: 'green' },
  { label: 'Expired Proposals', value: '4 Failed', icon: markRaw(PhXCircle), badge: '+2', badgeTone: 'neutral' },
  { label: 'Completed Proposals', value: '24 Completed', icon: markRaw(PhCheckCircle), badge: '+7', badgeTone: 'neutral' },
  { label: 'Avg. Proposal Value', value: '$11,540', icon: markRaw(PhChartPieSlice), badge: '-0.4%', badgeTone: 'red' },
]
...
<template>
  <main class="flex-1 overflow-y-auto bg-[#fbfbfc] dark:bg-[#0f0f0f] px-8 py-7">
    ...
    <div class="flex items-center justify-between mb-7">
      ...
      >
        <PhCalendarBlank :size="16" class="text-black/45 dark:text-white/45" />
        This Month
        <PhCaretDown :size="13" class="text-black/45 dark:text-white/45" />
      </button>
    </div>
    ...
    <div class="flex items-center justify-between mb-5">
      ...
      <div class="flex items-center gap-2.5">
        ...
        >
          <PhFunnel :size="16" class="text-black/45 dark:text-white/45" />
          Filter
          <PhCaretDown :size="13" class="text-black/45 dark:text-white/45" />
        </button>
        <button
          ...
          <tr class="border-b border-black/[0.06] dark:border-white/[0.07]">
            ...
            >
              <span class="inline-flex items-center gap-1">
                {{ col }}
                <PhCaretUpDown :size="13" class="text-black/25 dark:text-white/25" />
              </span>
            </th>
          </tr>
        </thead>
