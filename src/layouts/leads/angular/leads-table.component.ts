...
type Tab = 'All' | 'Favourite' | 'New' | 'Assigned to me' | 'Overdue' | 'Hot'
...
@Component({
  ...
  standalone: true,
  imports: [NgIconComponent, ScoreBarComponent],
  providers: [
    provideIcons({
      phosphorMagnifyingGlass,
      phosphorFunnelSimple,
    ...
    <div class="flex-1 flex flex-col min-h-0 bg-white dark:bg-[#0f0f0f]">
      ...
      <div class="flex items-center justify-between gap-3 px-7 py-3 shrink-0">
        <div class="flex items-center gap-2">
          ...
          >
            <ng-icon name="phosphorFunnelSimple" size="16" />
          </button>
          <button
            class="w-9 h-9 inline-flex items-center justify-center rounded-lg border border-black/[0.08] dark:border-white/[0.1] text-black/55 dark:text-white/55 hover:bg-black/[0.03] dark:hover:bg-white/[0.05] hover:text-black dark:hover:text-white transition-colors"
          >
            <ng-icon name="phosphorArrowsDownUp" size="16" />
          </button>
          <button
            class="w-9 h-9 inline-flex items-center justify-center rounded-lg border border-black/[0.08] dark:border-white/[0.1] text-black/55 dark:text-white/55 hover:bg-black/[0.03] dark:hover:bg-white/[0.05] hover:text-black dark:hover:text-white transition-colors"
          >
            <ng-icon name="phosphorSlidersHorizontal" size="16" />
          </button>
        </div>
        <div class="flex items-center gap-2">
          <div
          ...
          >
            ...
            >
              <ng-icon name="phosphorList" size="14" />
            </button>
            <button
          ...
          >
            <ng-icon name="phosphorDownloadSimple" size="15" />
            Import
          </button>
        </div>
      </div>
              ...
              >
                ...
                <td class="py-2.5 pr-4">
                  <div class="flex items-center gap-2.5">
                    <div [class]="'w-7 h-7 rounded-full bg-gradient-to-br shrink-0 ' + r.avatar"></div>
                ...
                <td class="py-2.5 text-right pr-1">
                  ...
                  >
                    <ng-icon name="phosphorDotsThreeBold" size="16" />
                  </button>
                </td>
              </tr>
            }
...
export class LeadsTableComponent {
  readonly tabs: Tab[] = ['All', 'Favourite', 'New', 'Assigned to me', 'Overdue', 'Hot']
  ...
  selected = signal(new Set<string>(['r4', 'r7', 'r8']))
